...
/**
 * Maps a treatment description to a fixed category label.
 * Returns the raw text unchanged if no keyword matches.
 */
export function classifyTreatment(text: string): string {
